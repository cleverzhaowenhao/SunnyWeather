...
private val sky = mapOf(
    ...
    "LIGHT_RAIN" to Sky("中雨", R.drawable.ic_moderate_rain, R.drawable.bg_rain),
    "MODERATE_RAIN" to Sky("小雨", R.drawable.ic_light_rain, R.drawable.bg_rain),
    ...
    "FOG" to Sky("轻度雾霾", R.drawable.ic_fog, R.drawable.bg_fog),
